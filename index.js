...
bot.command('book', async ctx => {
  ...
  await ctx.reply(
    'Вы начали процесс бронирования кабинетов! Обязательно посмотри свободные слоты в расписании <a href="https://dushepolezno.ru/prostranstvo-zapis">ссылка</a>. Сейчас я задам вам несколько вопросов о вашем мероприятии, чтобы передать эту информацию менеджеру. Для начала, введите ваше имя.', { parse_mode: 'HTML' }
  );
});
